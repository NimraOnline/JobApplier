  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl font-bold tracking-tight text-slate-900">Application Strategy Playbook</h2>
        ...
        <Card className="md:col-span-2 border-l-4 border-l-blue-600 shadow-md">
          ...
          <CardContent className="space-y-4 text-slate-700">
            <div className="flex gap-3">
              <Badge variant="outline" className="h-6">0</Badge>
        ...
        <Card className="border-l-4 border-l-cyan-500 shadow-md">
          ...
          <CardContent className="space-y-4">
             <div className="bg-cyan-50 p-4 rounded-lg border border-cyan-100">
                ...
                <p className="text-2xl font-black text-cyan-600 italic text-center">Tues - Thurs</p>
          ...
          <CardContent className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    <h4 className="font-bold text-sm text-slate-900">Step A: Immediate (24 Hours)</h4>
                    <p className="text-xs text-slate-600">Connect with recruiter on LinkedIn.</p>
                    <div className="p-3 bg-slate-50 rounded border text-xs italic text-slate-600">
                        "I applied for [role] today. Happy to provide additional information about my experience with [relevant skill]."
                    </div>
                </div>
                <div className="space-y-2">
                    <h4 className="font-bold text-sm text-slate-900">Step B: 3-5 Days Later</h4>
                    <p className="text-xs text-slate-600">Email hiring manager directly. <span className="text-green-600 font-bold">50% Success Rate.</span></p>
                    <div className="p-3 bg-green-50 border-green-100 rounded border text-xs text-slate-700">
          ...
          <CardContent>
            <div className="flex flex-wrap gap-2">
                {["App Date", "Company", "Role", "Source", "Follow-up Date", "Response? (Y/N)", "Interview? (Y/N)"].map(field => (
                    <Badge key={field} variant="secondary" className="bg-white border-slate-200">{field}</Badge>
                ))}
            </div>
